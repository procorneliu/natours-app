      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Loggin in was successfully!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"postData.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/imswagz/cm3orc9la009a01s7ac2x4k32',
    // style URL
    scrollZoom: false
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51QP2SORxBpYT9BfjQc5aEoaci6pS57lc44lVBTWvInfUC6FPEHU4dZaO5sy4Fsr2V6p5NUmpIM6iRwQFvE6oYtK3006gJR7tsi');
          _context.prev = 1;
          _context.next = 4;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"reviewStars.js":[function(require,module,exports) {
"use strict";
...
var reviewStars = document.querySelectorAll('.rating-radio');
var currentRating = document.getElementById('current-rating');
var setRating = exports.setRating = function setRating() {
  reviewStars.forEach(function (el) {
...
var _postData = require("./postData");
...
if (reviewForm) {
  (0, _reviewStars.setRating)();
  reviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var textarea, tour, user, review, rating;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            e.target.querySelector('.btn').textContent = 'Processing...';
            textarea = reviewForm.querySelector('#review');
            tour = textarea.dataset.tourId;
            user = textarea.dataset.userId;
            review = document.getElementById('review').value;
            rating = document.getElementById('current-rating').textContent;
            _context2.next = 9;
            return (0, _postData.postReview)({
              review: review,
              rating: rating,
              tour: tour,
              user: user
